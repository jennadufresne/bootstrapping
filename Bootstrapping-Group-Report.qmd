...
violenceHistogram <- ggplot(boot_data, aes(x = Deaths_InterpersonalViolence / Number_Of_Deaths)) +
                     xlab('Interpersonal Violence Death Rate') +
                     geom_histogram()
...
Based on the histograms for the cardiovascular diseases death rate and the interpersonal violence death rate, it appears that the death rate for cardiovascular diseases may follow a normal distribution. The interpersonal violence death rate does not appear to follow a normal distribution.

### Statistical Modeling

#### Estimating Population Mean and Standard Deviation

#### Construction Confidence Intervals on Regression Parameters
